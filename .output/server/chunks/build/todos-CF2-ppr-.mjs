                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    ssrRenderList(filteredTodos.value, (todo) => {
                      ...
                      _push3(`</span></div><div class="todo-item__content" data-v-1c9e9619${_scopeId2}><p class="todo-title" data-v-1c9e9619${_scopeId2}>${ssrInterpolate(todo.title)}</p><span class="todo-status" data-v-1c9e9619${_scopeId2}>${ssrInterpolate(todo.completed ? "Completado" : "Pendiente")}</span></div><button class="btn-delete" title="Eliminar tarea" data-v-1c9e9619${_scopeId2}> \u{1F5D1}\uFE0F </button></div>`);
                    });
                    _push3(`<!--]--></div>`);
                  } else {
                    return [
...
//# sourceMappingURL=todos-CF2-ppr-.mjs.map
