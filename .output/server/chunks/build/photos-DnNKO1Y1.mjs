  ...
  setup(__props) {
    ...
    const fetchPhotos = async () => {
      ...
      try {
        ...
        error.value = "Error al recuperar las fotos del \xE1lbum.";
      } finally {
        loading.value = false;
      }
    };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "photos-nested-view animate-slide-down" }, _attrs))} data-v-ece4f281><div class="photos-controls-row" data-v-ece4f281><h2 class="sub-section-title" data-v-ece4f281>Galer\xEDa de Fotos</h2>`);
      if (unref(currentUser)) {
        _push(`<button class="btn btn--primary btn--sm" data-v-ece4f281> \u{1F4F8} A\xF1adir Foto </button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="photos-filters" data-v-ece4f281><div class="search-box" data-v-ece4f281><input${ssrRenderAttr("value", searchQuery.value)} type="text" placeholder="Buscar foto por t\xEDtulo..." class="search-input" data-v-ece4f281></div><div class="stats-badge" data-v-ece4f281><span data-v-ece4f281>Total: <strong data-v-ece4f281>${ssrInterpolate(photos2.value.length)}</strong></span><span class="divider" data-v-ece4f281>|</span><span data-v-ece4f281>Visibles: <strong data-v-ece4f281>${ssrInterpolate(filteredPhotos.value.length)}</strong></span></div></div>`);
...
//# sourceMappingURL=photos-DnNKO1Y1.mjs.map
