...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.loading) {
        _push(`<div class="status-state loading-state" data-v-cfd85ec3><div class="spinner" data-v-cfd85ec3></div><p class="status-text" data-v-cfd85ec3>Cargando información...</p></div>`);
      } else if (__props.error) {
        _push(`<div class="status-state error-state animate-fade-in" data-v-cfd85ec3><div class="error-icon" data-v-cfd85ec3>⚠️</div><h3 class="status-title" data-v-cfd85ec3>Ha ocurrido un error</h3><p class="status-text" data-v-cfd85ec3>${ssrInterpolate(__props.error)}</p><button class="btn btn--danger-outline" data-v-cfd85ec3> 🔄 Reintentar </button></div>`);
      } else if (__props.isEmpty) {
        _push(`<div class="status-state empty-state animate-fade-in" data-v-cfd85ec3><div class="empty-icon" data-v-cfd85ec3>📁</div><h3 class="status-title" data-v-cfd85ec3>Sin resultados</h3><p class="status-text" data-v-cfd85ec3>No hay datos disponibles en esta sección.</p><button class="btn btn--primary-outline" data-v-cfd85ec3> 🔄 Actualizar </button></div>`);
      } else {
...
//# sourceMappingURL=StatusState-CW3PuAZY.js.map
