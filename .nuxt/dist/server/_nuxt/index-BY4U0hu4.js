...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "albums-page animate-fade-in" }, _attrs))} data-v-73cac4e0><div class="page-header" data-v-73cac4e0><div data-v-73cac4e0><h1 class="page-title" data-v-73cac4e0>Álbumes de Fotos</h1><p class="page-subtitle" data-v-73cac4e0>Organiza y visualiza galerías fotográficas.</p></div>`);
      if (unref(currentUser)) {
        _push(`<button class="btn btn--primary" data-v-73cac4e0> ➕ Crear Álbum </button>`);
      } else {
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(` 🔑 Inicia sesión para crear álbumes `);
            } else {
              return [
                createTextVNode(" 🔑 Inicia sesión para crear álbumes ")
              ];
            }
          }),
          _: 1
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  ssrRenderList(filteredAlbums.value, (album) => {
                    _push3(`<div class="album-card" data-v-73cac4e0${_scopeId2}><div class="album-card__cover" data-v-73cac4e0${_scopeId2}><span class="cover-icon" data-v-73cac4e0${_scopeId2}>🖼️</span></div><div class="album-card__body" data-v-73cac4e0${_scopeId2}><h3 class="album-card__title" data-v-73cac4e0${_scopeId2}>${ssrInterpolate(album.title)}</h3><p class="album-card__owner" data-v-73cac4e0${_scopeId2}>Propietario ID: ${ssrInterpolate(album.userId)}</p>`);
                      ...
                      (openBlock(true), createBlock(Fragment, null, renderList(filteredAlbums.value, (album) => {
                        return openBlock(), createBlock("div", {
                          ...
                          createVNode("div", { class: "album-card__cover" }, [
                            createVNode("span", { class: "cover-icon" }, "🖼️")
                          ]),
      ...
      if (showCreateModal.value) {
        _push(`<div class="modal-overlay" data-v-73cac4e0><div class="modal-card" data-v-73cac4e0><h2 class="modal-title" data-v-73cac4e0>Nuevo Álbum</h2><form data-v-73cac4e0><div class="form-group" data-v-73cac4e0><label for="album-title" data-v-73cac4e0>Título del Álbum</label><input${ssrRenderAttr("value", newAlbumTitle.value)} id="album-title" type="text" placeholder="Escribe el nombre del álbum..." required data-v-73cac4e0></div><div class="modal-buttons" data-v-73cac4e0><button type="button" class="btn btn--secondary-outline" data-v-73cac4e0>Cancelar</button><button type="submit" class="btn btn--primary"${ssrIncludeBooleanAttr(submitting.value) ? " disabled" : ""} data-v-73cac4e0>${ssrInterpolate(submitting.value ? "Creando..." : "Crear Álbum")}</button></div></form></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
//# sourceMappingURL=index-BY4U0hu4.js.map
