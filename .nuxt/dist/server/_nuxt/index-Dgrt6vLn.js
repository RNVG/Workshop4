...
import { u as useFirebase, a as useFirestore, S as StatusState } from "./StatusState-CW3PuAZY.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "dashboard-page animate-fade-in" }, _attrs))} data-v-28aba1a3><header class="dashboard-hero" data-v-28aba1a3><h1 class="hero-title" data-v-28aba1a3>Workshop Firebase + Firestore</h1><p class="hero-subtitle" data-v-28aba1a3> Una migración completa desde APIs REST hacia un backend en tiempo real con Nuxt 3. </p><div class="seeder-box" data-v-28aba1a3><p class="seeder-text" data-v-28aba1a3> ¿La base de datos está vacía? Siembra datos de prueba en Firestore para empezar. </p><button class="btn btn--primary"${ssrIncludeBooleanAttr(unref(seeding2)) ? " disabled" : ""} data-v-28aba1a3>${ssrInterpolate(unref(seeding2) ? "Sembrando..." : "⚙️ Sembrar Datos de Prueba")}</button>`);
      if (unref(seedMessage2)) {
        _push(`<p class="seed-message" data-v-28aba1a3>${ssrInterpolate(unref(seedMessage2))}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></header><section class="stats-section" data-v-28aba1a3><h2 class="section-title" data-v-28aba1a3>Estadísticas del Servidor (Firestore)</h2>`);
      _push(ssrRenderComponent(StatusState, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="stats-grid" data-v-28aba1a3${_scopeId}><div class="stat-card" data-v-28aba1a3${_scopeId}><span class="stat-icon" data-v-28aba1a3${_scopeId}>📝</span><div class="stat-info" data-v-28aba1a3${_scopeId}><span class="stat-value" data-v-28aba1a3${_scopeId}>${ssrInterpolate(stats.value.posts)}</span><span class="stat-label" data-v-28aba1a3${_scopeId}>Posts Creados</span></div></div><div class="stat-card" data-v-28aba1a3${_scopeId}><span class="stat-icon" data-v-28aba1a3${_scopeId}>🎨</span><div class="stat-info" data-v-28aba1a3${_scopeId}><span class="stat-value" data-v-28aba1a3${_scopeId}>${ssrInterpolate(stats.value.albums)}</span><span class="stat-label" data-v-28aba1a3${_scopeId}>Álbumes</span></div></div><div class="stat-card" data-v-28aba1a3${_scopeId}><span class="stat-icon" data-v-28aba1a3${_scopeId}>💬</span><div class="stat-info" data-v-28aba1a3${_scopeId}><span class="stat-value" data-v-28aba1a3${_scopeId}>${ssrInterpolate(stats.value.comments)}</span><span class="stat-label" data-v-28aba1a3${_scopeId}>Comentarios</span></div></div><div class="stat-card" data-v-28aba1a3${_scopeId}><span class="stat-icon" data-v-28aba1a3${_scopeId}>✅</span><div class="stat-info" data-v-28aba1a3${_scopeId}><span class="stat-value" data-v-28aba1a3${_scopeId}>${ssrInterpolate(stats.value.todos)}</span><span class="stat-label" data-v-28aba1a3${_scopeId}>Tareas Listas</span></div></div></div>`);
          } else {
            return [
              createVNode("div", { class: "stats-grid" }, [
                ...
                createVNode("div", { class: "stat-card" }, [
                  ...
                  createVNode("div", { class: "stat-info" }, [
                    ...
                    createVNode("span", { class: "stat-label" }, "Álbumes")
                  ])
                ]),
                createVNode("div", { class: "stat-card" }, [
                  createVNode("span", { class: "stat-icon" }, "💬"),
      ...
      _push(`</section><section class="navigation-section" data-v-28aba1a3><h2 class="section-title" data-v-28aba1a3>Explorar Módulos</h2><div class="nav-grid" data-v-28aba1a3>`);
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="nav-card__icon" data-v-28aba1a3${_scopeId}>albums</div><h3 data-v-28aba1a3${_scopeId}>Álbumes de Fotos</h3><p data-v-28aba1a3${_scopeId}>Organiza álbumes y fotos mediante relaciones dinámicas.</p><span class="nav-card__arrow" data-v-28aba1a3${_scopeId}>Ir a Álbumes →</span>`);
          } else {
            return [
              createVNode("div", { class: "nav-card__icon" }, "albums"),
              createVNode("h3", null, "Álbumes de Fotos"),
              createVNode("p", null, "Organiza álbumes y fotos mediante relaciones dinámicas."),
              createVNode("span", { class: "nav-card__arrow" }, "Ir a Álbumes →")
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="nav-card__icon" data-v-28aba1a3${_scopeId}>todos</div><h3 data-v-28aba1a3${_scopeId}>Gestor de Tareas</h3><p data-v-28aba1a3${_scopeId}>Crea check-lists, marca completados y adminístralos en tiempo real.</p><span class="nav-card__arrow" data-v-28aba1a3${_scopeId}>Ver Tareas →</span>`);
          } else {
            return [
              createVNode("div", { class: "nav-card__icon" }, "todos"),
              createVNode("h3", null, "Gestor de Tareas"),
              createVNode("p", null, "Crea check-lists, marca completados y adminístralos en tiempo real."),
...
//# sourceMappingURL=index-Dgrt6vLn.js.map
