  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(currentUser)) {
        _push(`<button class="btn btn--primary" data-v-f5fecf1a> ➕ Crear Publicación </button>`);
      } else {
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(` 🔑 Inicia sesión para publicar `);
            } else {
              return [
                createTextVNode(" 🔑 Inicia sesión para publicar ")
              ];
            }
          }),
          _: 1
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  ssrRenderList(filteredPosts.value, (post) => {
                    _push3(`<div class="post-card" data-v-f5fecf1a${_scopeId2}><div class="post-card__content" data-v-f5fecf1a${_scopeId2}><h3 class="post-card__title" data-v-f5fecf1a${_scopeId2}>${ssrInterpolate(post.title)}</h3><p class="post-card__body" data-v-f5fecf1a${_scopeId2}>${ssrInterpolate(truncate(post.body, 120))}</p><div class="post-card__author" data-v-f5fecf1a${_scopeId2}><span class="author-icon" data-v-f5fecf1a${_scopeId2}>👤</span><span class="author-name" data-v-f5fecf1a${_scopeId2}>ID Usuario: ${ssrInterpolate(post.userId)}</span></div></div><div class="post-card__actions" data-v-f5fecf1a${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_NuxtLink, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(` 👁️ Ver Detalle `);
                        } else {
                          return [
                            createTextVNode(" 👁️ Ver Detalle ")
                          ];
                        }
                      }),
                      _: 2
                    ...
                    if (unref(currentUser) && (unref(currentUser).uid === post.userId || post.userId.startsWith("user_"))) {
                      _push3(`<!--[--><button class="btn-action btn-action--edit" data-v-f5fecf1a${_scopeId2}> ✏️ Editar </button><button class="btn-action btn-action--delete" data-v-f5fecf1a${_scopeId2}> 🗑️ Borrar </button><!--]-->`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(`</div></div>`);
                        ...
                        return openBlock(), createBlock("div", {
                          ...
                          createVNode("div", { class: "post-card__content" }, [
                            ...
                            createVNode("div", { class: "post-card__author" }, [
                              createVNode("span", { class: "author-icon" }, "👤"),
...
//# sourceMappingURL=index-CwBBiECl.js.map
