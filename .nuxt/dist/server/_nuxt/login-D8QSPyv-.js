...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "auth-page" }, _attrs))} data-v-eb35c961><h1 data-v-eb35c961>Iniciar sesión</h1><div class="auth-card" data-v-eb35c961><p data-v-eb35c961>Accede con Google para continuar en el workshop.</p><button class="btn btn--primary"${ssrIncludeBooleanAttr(unref(loading)) ? " disabled" : ""} data-v-eb35c961>${ssrInterpolate(unref(loading) ? "Iniciando..." : "Iniciar con Google")}</button>`);
      if (unref(error)) {
...
//# sourceMappingURL=login-D8QSPyv-.js.map
