    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(StatusState, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (post.value) {
              _push2(`<div class="post-detail" data-v-ccc9d141${_scopeId}><article class="post-main" data-v-ccc9d141${_scopeId}><h1 class="post-title" data-v-ccc9d141${_scopeId}>${ssrInterpolate(post.value.title)}</h1><p class="post-body" data-v-ccc9d141${_scopeId}>${ssrInterpolate(post.value.body)}</p><div class="post-meta" data-v-ccc9d141${_scopeId}><span class="meta-item" data-v-ccc9d141${_scopeId}>👤 Autor ID: ${ssrInterpolate(post.value.userId)}</span>`);
              if (post.value.createdAt) {
                _push2(`<span class="meta-item" data-v-ccc9d141${_scopeId}> 📅 ${ssrInterpolate(formatDate(post.value.createdAt))}</span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
              if (unref(currentUser) && (unref(currentUser).uid === post.value.userId || post.value.userId.startsWith("user_"))) {
                _push2(`<div class="post-actions" data-v-ccc9d141${_scopeId}><button class="btn btn--warning-outline" data-v-ccc9d141${_scopeId}>✏️ Editar Post</button><button class="btn btn--danger-outline" data-v-ccc9d141${_scopeId}>🗑️ Eliminar Post</button></div>`);
              } else {
                _push2(`<!---->`);
              }
              ...
              if (!isShowingComments.value) {
                _push2(ssrRenderComponent(_component_NuxtLink, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(` 💬 Cargar Comentarios `);
                    } else {
                      return [
                        createTextVNode(" 💬 Cargar Comentarios ")
                      ];
                    }
                  }),
                  _: 1
                ...
                _push2(ssrRenderComponent(_component_NuxtLink, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(` 🙈 Ocultar Comentarios `);
                    } else {
                      return [
                        createTextVNode(" 🙈 Ocultar Comentarios ")
                      ];
                    }
                  }),
                  _: 1
              ...
              if (!isShowingComments.value) {
                _push2(`<div class="comments-placeholder" data-v-ccc9d141${_scopeId}><p data-v-ccc9d141${_scopeId}>Presiona &quot;Cargar Comentarios&quot; para ver la discusión.</p></div>`);
              } else {
                _push2(`<!---->`);
              }
              ...
              post.value ? (openBlock(), createBlock("div", {
                ...
                createVNode("article", { class: "post-main" }, [
                  ...
                  createVNode("div", { class: "post-meta" }, [
                    createVNode("span", { class: "meta-item" }, "👤 Autor ID: " + toDisplayString(post.value.userId), 1),
                    post.value.createdAt ? (openBlock(), createBlock("span", {
                      key: 0,
                      class: "meta-item"
                    }, " 📅 " + toDisplayString(formatDate(post.value.createdAt)), 1)) : createCommentVNode("", true)
                  ]),
                ...
                createVNode("section", { class: "comments-section" }, [
                  ...
                  createVNode("div", { class: "nested-comments-container" }, [
                    ...
                    !isShowingComments.value ? (openBlock(), createBlock("div", {
                      ...
                      createVNode("p", null, 'Presiona "Cargar Comentarios" para ver la discusión.')
                    ])) : createCommentVNode("", true)
                  ])
                ])
              ])) : createCommentVNode("", true)
...
//# sourceMappingURL=_id_-bffaER3g.js.map
